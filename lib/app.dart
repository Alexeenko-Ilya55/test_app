...
import 'package:test_app/common/app_language/presentation/provider/language_provider.dart';
...
class TestApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TokenBlocProvider(
      builder: (context, tokenState) => LanguageBlocProvider(
        builder: (context, languageState) {
          final router = tokenState.token != null
